...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> cancelOrder(
        ...
        return ResponseEntity.ok(orderService.cancelOrder(userDetails.getUsername(),orderCode));
    }

    //shop xem danh sách đơn hàng của mk
    @GetMapping("/shop")
    ...
    public ResponseEntity<OrderResponse> updateStatus(
        ...
        return ResponseEntity.ok(orderService.updateStatus(userDetails.getUsername(), orderCode,status));
    }
}
