        ...
        <>
            <Routes>
                ...
                <Route path="/orders" element={
                    <ProtectedRoute roles={["ROLE_USER", "ROLE_ADMIN"]}><Orders /></ProtectedRoute>
                } />
                <Route path="/profile/address" element={
                    <ProtectedRoute roles={["ROLE_USER", "ROLE_ADMIN"]}><AddressManager /></ProtectedRoute>
                } />
                <Route path="/register-shop" element={
                    <ProtectedRoute roles={["ROLE_USER"]}><RegisterShop /></ProtectedRoute>
                } />
                <Route path="/register-shop/status" element={
                    <ProtectedRoute roles={["ROLE_USER"]}><RegisterShopStatus /></ProtectedRoute>
                } />
